...
std::map<std::string, std::string> *LXCMModules::_modules = NULL;

std::map<std::string, std::string>* LXCMModules::getModules (void)
{
	if (NULL == LXCMModules::_modules)
	{
		LXCMModules::_modules = new std::map<std::string, std::string> ();
	}
